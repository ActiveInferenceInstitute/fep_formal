...
R0_REPAIR_SHA256 = "8ade7f9f052b054150501ec85b81c26e0c68b06cedffef2bb90c6db7ac0eed67"
R0_LIFECYCLE_SHA256 = "f733c5698039d509d9b9e65a5f3d69c835005ed7b9b698a986803733ecbbdc78"
...
PRESERVED_HASHES = {
    ...
    R0_TEST: "1828eaaec7538004989cddfb87ebdcd7f4da455f7991d8dfc454e59d80791b82",
}
...
def test_h2_5d_projected_module_imports_with_native_instances_and_boundary(
    ...
    emit = run_lean_compile_probe(
        ...
        executable=lake_executable(
            missing="raise",
            context="H2.5d native validation",
        ),
    )
