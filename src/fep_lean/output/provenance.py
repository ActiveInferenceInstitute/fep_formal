...
SOURCE_OWNER_ROSTER: tuple[str, ...] = (
    ...
    "scripts/build_render_fonts.py",
    "scripts/build_release_bundle.py",
    "scripts/capture_browser_acceptance.py",
    "scripts/check_render_log.py",
    "scripts/prove2me.py",
    ...
    "src/fep_lean/catalogue/theorem_maturity_projection.py",
    ...
    "src/fep_lean/cli.py",
    "src/fep_lean/custody/__init__.py",
    "src/fep_lean/custody/apply.py",
    "src/fep_lean/custody/census.py",
    "src/fep_lean/custody/cli.py",
    "src/fep_lean/custody/model.py",
    "src/fep_lean/custody/verify.py",
    ...
    "src/fep_lean/output/graphical_abstract.py",
    ...
    "src/fep_lean/prove2me/__init__.py",
    "src/fep_lean/prove2me/client.py",
    "src/fep_lean/prove2me/config.py",
    "src/fep_lean/prove2me/missions.py",
